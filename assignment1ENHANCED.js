...
document.addEventListener("DOMContentLoaded", function() { 
    ...
    .then(galleries => {
        loadGenerator(document.querySelector(".box.b section"), document.querySelector(".box.b")); 
    ...
    function populateGallery(galleries) {
        ...
        //make box b visible 
        removeLoader(document.querySelector(".box.b section")); 
        ...
        document.querySelectorAll("li").forEach(listItem => { 
            listItem.addEventListener('click', (e) => {
                ...
                //load images generated for boxes a and c 
                loadGenerator(document.querySelector(".box.a section"), document.querySelector(".box.a")); 
                loadGenerator(document.querySelector(".box.c section"), document.querySelector(".box.c")); 
    ...
    function modalImgGen(image) { 
        ...
        //changes modal from being invisible to visible 
        modal.style.display = "block"; 
        
        //adds click event to modal image, if clicked modal is deleted
    ...
    /**
      ...
      *
      * @param contentHide
      * Passes in the section element to be hidden
      *
      * @param box 
      * Passes the box div element to append the load image to 
      *
      */
    
    function loadGenerator(contentHide, box) { 
        
        //hides section 
        contentHide.style.display = 'none';
        
        //creates section image element
        sectionImage = document.createElement('section'); 
        sectionImage.setAttribute('id', 'loading');   
      
        //creates actual image 
        img = document.createElement('img'); 
        img.setAttribute('src', 'https://cutewallpaper.org/21/loading-animated-gif-transparent-background/HopeWell.gif');
      
        //appends image to section div, then section element to box div
        sectionImage.appendChild(img); 
        box.appendChild(sectionImage); 
        
    }
    
    
    /**
      * Removes a load image 
      *
      * @param contentDisplay
      * Passes in the section element to be displayed once more
      *
      */
    
    function removeLoader (contentDisplay) { 
        
        //if condition to see if section element being passed in is part of box a
        //box a must be grid 
        //any other box is block 
        if (contentDisplay == document.querySelector('.box.a section')) { 
            contentDisplay.style.display = "grid";
        }
        else { 
            contentDisplay.style.display = 'block';
        }
        //Selects an existing load section, then removes it. 
